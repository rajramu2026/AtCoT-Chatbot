...
const CONFIG = {
  ...
  //    NOTE: Groq deprecated "llama-3.1-8b-instant" on 16 Aug 2026. Using
  //    their recommended replacement below. If Groq ever deprecates this
  //    one too, check https://console.groq.com/docs/models for the current
  //    model id and swap it in here — nothing else needs to change.
  LLM_PROVIDER: "groq",
  ...
  DEFAULT_API_KEY: "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",
};
